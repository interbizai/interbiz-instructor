...
const APP_SHELL = [
  ...
  '/login-hicare.html',
  '/manifest.json',
  '/assets/css/app.css?v1.1.2',
  '/assets/css/login.css',
  '/assets/js/login.js',
  '/assets/js/01-core-db.js?v1.1.2',
  '/assets/js/02-state.js?v1.1.2',
  '/assets/js/03-nav-auth.js?v1.1.2',
  '/assets/js/04-admin-edu.js?v1.1.2',
  '/assets/js/05-home-analysis.js?v1.1.2',
  '/assets/js/06-voice-calendar.js?v1.1.2',
  '/assets/js/07-dashboard-my.js?v1.1.2',
  '/assets/js/08-lecturer.js?v1.1.2',
  '/assets/js/09-admin-panel.js?v1.1.2',
  '/assets/js/10-ui-init.js?v1.1.2',
  '/assets/js/video-protect.js?v1.1.2',
