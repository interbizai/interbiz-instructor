...
# 응답 JSON 스키마 (반드시 이 구조로만 응답)
{
  ...
  "teaching_patterns": [{"type":"도입|설명|질문 유도|피드백|마무리|기타","original":"영상에서 강사가 실제 말한 원 화법 + MM:SS 시점","alternative":"세계적 전문 강사 코치로서 추천하는 대체 화법","reason":"왜 대체 화법이 더 효과적인지 1~2문장 근거"}],
...
- alternative는 세계적 전문 강사 코치 관점의 "이렇게 말했더라면" 추천 화법
- reason은 왜 대체 화법이 더 효과적인지 구체 근거 (청중 주의 환기·신뢰·전환율 등)
- type 범주를 다양하게 (도입·설명·질문 유도·피드백·마무리 등에서 골고루 선택)
